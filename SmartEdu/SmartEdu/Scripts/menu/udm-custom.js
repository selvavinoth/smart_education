...
um.baseSRC = "Content/themes/base/images/menu/";
...
um.items = [
	...
	"#2D70B7",// visited border colors ["color"|"#hex"|"rgb()"] (single, double or four values)
	...
	"transparent", //"none",//"2.png",//"MenuBgNew.png",//"MenuBg.gif",//"menu_unselected.gif",//"#2D70B7",//"#ffc",		// background ["color"|"#hex"|"rgb()"|"image.gif"]
	"transparent", //"#ecefc6",		// hover/focus background ["color"|"#hex"|"rgb()"|"image.gif"]
	"transparent", //"none",//"2.png",//"MenuBgNew.png",//"MenuBg.gif",//"menu_unselected.gif",//"#2D70B7",// visited background ["color"|"#hex"|"rgb()"|"image.gif"]
	...
	"White",//"#ffffff",	// color ["color"|"#hex"|"rgb()"]
	"Black",//"#b05010",	// hover/focus color ["color"|"#hex"|"rgb()"]
	"White",//"#ffffff",	// visited color ["color"|"#hex"|"rgb()"]
	...
	"down-black.gif", // menu indicator rollover character/image ["text"|"image.gif"|"none"] (must be same type)
...
um.menuItems = [
	...
	"5",		// top/bottom padding ["n" pixels] (single value only)
	"#0058AF", //"#c8e8ff",//"2.png",//"#034E7B",//"#2D70B7",//"menu_unselected.gif",// background ["color"|"#hex"|"rgb()"|"image.gif"]
	"#42AEF8", //"#ecefc6",	// hover/focus background ["color"|"#hex"|"rgb()"|"image.gif"]
	"#0058AF", //"#c8e8ff",//"2.png",//"#034E7B",//"#2D70B7",//"menu_unselected.gif",// visited background ["color"|"#hex"|"rgb()"|"image.gif"]
	"11px",		// font size ["em"|"ex"|"%"|"px"|"pt"|"absolute-size"|"relative-size"]
	"Arial",// font family ["font1,font2,font3"] (always end with a generic family name)
	"bold",	// font weight ["normal"|"bold"|"bolder"|"lighter|"100" to "900"]
	"none",		// text decoration ["none"|"underline"|"overline"|"line-through"]
	"left",		// text-align ["left"|"right"|"center"]
	"White",//"#060",		// color ["color"|"#hex"|"rgb()"]
	"Black",//"#b05010",		// hover/focus color ["color"|"#hex"|"rgb()"]
